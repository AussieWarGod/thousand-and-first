...
7,695 / 7,695 cases against the configured licensed Qud base; the portable suite passes 173 / 173.
Both recorded runs report zero skipped. The Tools suite passes 33 tests and the Art suite passes 19.
Baseline and compatibility-symbol staged compiles are clean across 1307 production C# sources; the
cold-install inventory contains 1331 files. This does not close native behavior or the representative
...
installation. The structural release gate also remains red: 52 staged sources breach the line cap
