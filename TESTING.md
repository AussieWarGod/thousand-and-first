...
Staged compatibility compilation runs across 3065 production C# sources, staged baseline across
3061 (the optional-mod bridge is a compatibility-only source); the generated
cold-install inventory contains 3096 files. Neither count proves subscriber delivery.
