		...
		private static void Run()
		{
			...
			try
			{
				...
				using (scope)
				{
					...
					Require(KingdomResidents.TryResident(system.City, residentId, out var visited)
						&& visited.BoundZoneId == awayId, "visit did not bind the same living resident to the actual map");
			...
			{
				// Restore only the controlled physical transfer. Never repair a lost home or row.
