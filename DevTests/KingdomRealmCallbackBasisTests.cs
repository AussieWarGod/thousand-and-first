...
namespace ThousandAndFirst.Tests
{
	...
	public sealed class KingdomRealmCallbackBasisTests
	{
		...
		[TestCase(KingdomRealmCallbackPhase.Intent, KingdomArchivedSettlementCodec.CurrentVersion, 0, true)]
		[TestCase(KingdomRealmCallbackPhase.Intent, 18, 1, false)]
		[TestCase(KingdomRealmCallbackPhase.Intent, KingdomArchivedSettlementCodec.CurrentVersion + 1, 0, false)]
		...
		[TestCase(KingdomRealmCallbackPhase.Attempting, KingdomArchivedSettlementCodec.CurrentVersion + 1, 0, false)]
		...
		[TestCase(KingdomRealmCallbackPhase.Settled, KingdomArchivedSettlementCodec.CurrentVersion + 1, 5, false)]
		[TestCase(KingdomRealmCallbackPhase.Settled, 5, KingdomArchivedSettlementCodec.CurrentVersion + 1, false)]
