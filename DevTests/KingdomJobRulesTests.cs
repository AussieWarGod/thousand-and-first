	...
	internal class KingdomJobRulesTests
	{
		...
		public void RegistryPublicSaveColumnsKeepTheirExactMetadataShapeAndOrder()
		{
			...
			string[] expected = new string[]
			{
				...
				"ProvisionCosts", "OutcomeCodes", "ExpeditionDeedDispositions",
				"ExpeditionDeedPolityIds", "ExpeditionDeedCauseRefs",
				"ExpeditionDeedFigureRefs", "DeliverySourceEndpointIds",
