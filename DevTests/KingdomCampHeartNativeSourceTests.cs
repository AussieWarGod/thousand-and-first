...
namespace ThousandAndFirst.Tests
{
	...
	public class KingdomCampHeartNativeSourceTests
	{
		...
		{
			Assert.That(Read(Phases), Does.Contain("if (!Begun) RecordBlockedMessages();"));
			Assert.That(Read(Phases), Does.Contain("List<string> notes = Game.Player?.Messages?.Messages;"));
