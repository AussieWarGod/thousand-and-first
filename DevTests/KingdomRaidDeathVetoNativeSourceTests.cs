...
namespace ThousandAndFirst.Tests
{
	...
	public sealed class KingdomRaidDeathVetoNativeSourceTests
	{
		...
		public void PersonaKeepsVetoRetryIsolatedAndHasExactTerminalExpectation()
		{
			...
			ClassicAssert.AreEqual("raid-death-veto-native-check", Setting(source, "VERBS"));
			ClassicAssert.AreEqual("stagedigest;raid-death-veto-native-check;stagedigest", Setting(source, "SCRIPT"));
			ClassicAssert.AreEqual("stagedigest:OK~founded=false,raid-death-veto-native-check:OK~cases=1 passed=1 failed=0,"
