...
namespace ThousandAndFirst.Tests
{
	public class KingdomUpgradeRulesTests
	{
		...
		public void DecomposedNestedTypes_PreserveIdentityValuesFieldsAndDefaults()
		{
			...
			ClassicAssert.AreEqual("ThousandAndFirst.KingdomUpgradeRules+UpgradeVerdict", verdict.FullName);
			ClassicAssert.AreEqual(typeof(int), Enum.GetUnderlyingType(verdict));
			ClassicAssert.AreEqual("Ready|NoSuccessor|SuccessorUnknown|StyleForbids|NotOurWork|AlreadyWorking|HeldOnThisGround|HeldByFounder|StageTooLow|NotEnoughHands|WouldSpill|NotEnoughWater|WorksElsewhere|NoGroundToGrow|CraftNotMet|NotEnoughMaterial",
				string.Join("|", Enum.GetNames(verdict)));
			Array verdicts = Enum.GetValues(verdict);
			for (int i = 0; i < verdicts.Length; i++)
			{
				ClassicAssert.AreEqual(i, Convert.ToInt32(verdicts.GetValue(i)), "verdict " + i);
			}

			Type chainType = typeof(KingdomUpgradeRules.UpgradeChain);
			ClassicAssert.AreEqual("ThousandAndFirst.KingdomUpgradeRules+UpgradeChain", chainType.FullName);
			ClassicAssert.AreEqual("SuccessorKey|CostDramsOverride|BuildTicksOverride|CrewOverride|HasMinStageOverride|MinStageOverride",
				DeclaredFieldNames(chainType));
			KingdomUpgradeRules.UpgradeChain chain = new KingdomUpgradeRules.UpgradeChain();
			ClassicAssert.AreEqual(KingdomUpgradeRules.Unset, chain.CostDramsOverride);
			ClassicAssert.AreEqual(KingdomUpgradeRules.UnsetTicks, chain.BuildTicksOverride);
			ClassicAssert.AreEqual(KingdomUpgradeRules.Unset, chain.CrewOverride);
			ClassicAssert.IsFalse(chain.HasMinStageOverride);
			ClassicAssert.IsFalse(chain.Defined);

			Type demandType = typeof(KingdomUpgradeRules.ImprovementDemand);
			ClassicAssert.AreEqual("ThousandAndFirst.KingdomUpgradeRules+ImprovementDemand", demandType.FullName);
			ClassicAssert.AreEqual("MaterialsInHand|CraftMet|CraftDetail|KnowledgeMissing",
				DeclaredFieldNames(demandType));
			ClassicAssert.IsTrue(KingdomUpgradeRules.ImprovementDemand.None.MaterialsInHand);
			ClassicAssert.IsTrue(KingdomUpgradeRules.ImprovementDemand.None.CraftMet);
		}
		...
		{
			ClassicAssert.IsFalse(KingdomUpgradeRules.CraftGateAdmits(verdict));
		}
		...
		{
			ClassicAssert.IsTrue(KingdomUpgradeRules.CraftGateAdmits(verdict));
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.CostDrams(successor, predecessor, over));
		}
		...
		public void CostDrams_NeverFree_EvenWhenTheSuccessorIsNoDearer(int successor, int predecessor)
		{
			...
			ClassicAssert.AreEqual(KingdomUpgradeRules.MinimumCostDrams, KingdomUpgradeRules.CostDrams(successor, predecessor, KingdomUpgradeRules.Unset));
		}
		...
		public void CostDrams_NeverDearerThanBuildingTheSuccessorFresh(int successor, int predecessor)
		{
			...
			ClassicAssert.AreEqual(successor, cost);
			ClassicAssert.LessOrEqual(cost, successor);
		}
		...
		public void CostDrams_AnAuthoredCostIsTakenExactly(int over)
		{
			...
			ClassicAssert.AreEqual(over, KingdomUpgradeRules.CostDrams(16, 4, over));
		}
		...
		public void CostDrams_TreatsNegativeDesignCostsAsNothingAndLetsTheCapWin()
		{
			...
			ClassicAssert.AreEqual(0, KingdomUpgradeRules.CostDrams(-5, -5, KingdomUpgradeRules.Unset));
			ClassicAssert.AreEqual(0, KingdomUpgradeRules.CostDrams(0, -5, KingdomUpgradeRules.Unset));
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.BuildTicks(successorTicks, KingdomUpgradeRules.UnsetTicks));
			ClassicAssert.AreEqual(expected, successorTicks * KingdomUpgradeRules.BuildTicksPercent / 100L);
		}
		...
		{
			ClassicAssert.AreEqual(1L, KingdomUpgradeRules.BuildTicks(successorTicks, KingdomUpgradeRules.UnsetTicks));
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.BuildTicks(3600L, over));
		}

		[Test]
		public void BuildTicks_ANonPositiveOverrideIsNoOverride()
		{
			ClassicAssert.AreEqual(2700L, KingdomUpgradeRules.BuildTicks(3600L, KingdomUpgradeRules.UnsetTicks));
			ClassicAssert.AreEqual(2700L, KingdomUpgradeRules.BuildTicks(3600L, -1L));
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.BuildTicks(3600L,
		...
		{
			ClassicAssert.AreEqual(2700L, KingdomUpgradeRules.BuildTicks(3600L,
				KingdomUpgradeRules.UnsetTicks, infrastructurePercent));
		}
		...
		{
			ClassicAssert.AreEqual(1350L, KingdomUpgradeRules.BuildTicks(3600L,
				KingdomUpgradeRules.UnsetTicks, infrastructurePercent));
		}
		...
		{
			ClassicAssert.AreEqual(1500L, KingdomUpgradeRules.BuildTicks(3600L, 1500L, 50));
			long huge = KingdomUpgradeRules.BuildTicks(long.MaxValue,
				KingdomUpgradeRules.UnsetTicks, 80);
			ClassicAssert.Greater(huge, 0L);
			ClassicAssert.Less(huge, long.MaxValue);
		}
		...
		public void CrewRequired_DefaultsToTheCrewTheSuccessorWillNeedAndNeverNobody(int successorStaff, int over, int expected)
		{
			...
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.CrewRequired(successorStaff, over));
		}
		...
		public void StageRequired_InheritsTheSuccessorsGateAndOnlyEverTightensIt(GrowthStage successorMinStage, bool hasOverride, GrowthStage over, GrowthStage expected)
		{
			...
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.StageRequired(successorMinStage, hasOverride, over));
		}
		...
		public void ReserveDrams_IsTheNamedReserveDepthAtThisSettlementsOwnRate(int population, GrowthStage stage)
		{
			...
			ClassicAssert.AreEqual(KingdomRules.UpkeepDrams(population, stage) * KingdomRules.ReserveDays,
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.CanAfford(stored, cost, reserve));
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.Shortfall(stored, cost, reserve));
		}
		...
		public void Shortfall_IsZeroExactlyWhenItIsAffordable(int stored, int cost, int reserve)
		{
			...
			ClassicAssert.AreEqual(KingdomUpgradeRules.CanAfford(stored, cost, reserve),
		...
		{
			ClassicAssert.IsTrue(KingdomUpgradeRules.ContentsWouldFit(0, 0, 0, SuccessorHoldsItems: false));
			ClassicAssert.IsTrue(KingdomUpgradeRules.ContentsWouldFit(0, KingdomUpgradeRules.UnknownCapacity, 0, SuccessorHoldsItems: false));
		}
		...
		public void ContentsWouldFit_RefusesWhenWhatIsStoredHasNowhereToGo(int heldItems)
		{
			...
			ClassicAssert.IsFalse(KingdomUpgradeRules.ContentsWouldFit(0, KingdomUpgradeRules.UnknownCapacity, heldItems, SuccessorHoldsItems: false));
			ClassicAssert.IsTrue(KingdomUpgradeRules.ContentsWouldFit(0, KingdomUpgradeRules.UnknownCapacity, heldItems, SuccessorHoldsItems: true));
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.ContentsWouldFit(storedLiquid, capacity, 0, SuccessorHoldsItems: true));
		}
		...
		public void ContentsWouldFit_AnUndeclaredCapacityCannotProveSafeCustody(int storedLiquid)
		{
			...
			ClassicAssert.IsFalse(KingdomUpgradeRules.ContentsWouldFit(storedLiquid,
		...
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.Ready, AssessReady());
		}

		[Test]
		public void Assess_NoSuccessorIsTheStateEveryDesignShipsIn()
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NoSuccessor, AssessReady(HasSuccessor: false));
		}

		[Test]
		public void Assess_AnUnresolvableSuccessorIsReportedRatherThanIgnored()
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.SuccessorUnknown, AssessReady(SuccessorKnown: false));
			ClassicAssert.IsTrue(KingdomUpgradeRules.IsBlocked(KingdomUpgradeRules.UpgradeVerdict.SuccessorUnknown));
		}
		...
		public void Assess_TheSettlementNeverRebuildsWhatThePlayerMade()
		{
			...
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotOurWork, AssessReady(OurWork: false));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotOurWork, AssessReady(OurWork: false, StyleAllowed: false, AlreadyWorking: true,
		...
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.StyleForbids, AssessReady(StyleAllowed: false));
			ClassicAssert.IsFalse(KingdomUpgradeRules.IsBlocked(KingdomUpgradeRules.UpgradeVerdict.StyleForbids));
		}

		[Test]
		public void Assess_WorkAlreadyUnderWayIsNotAStall()
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.AlreadyWorking, AssessReady(AlreadyWorking: true));
			ClassicAssert.IsFalse(KingdomUpgradeRules.IsBlocked(KingdomUpgradeRules.UpgradeVerdict.AlreadyWorking));
		}
		...
		public void Assess_AFounderWhoHeldAWorkIsNeverLecturedAboutItsWater()
		{
			...
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.HeldOnThisGround, AssessReady(HeldOnThisGround: true,
				Stage: GrowthStage.Camp, FreeHands: 0, ContentsFit: false, StoredWater: 0, OtherWorkUnderway: true));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.HeldByFounder, AssessReady(HeldByFounder: true,
				Stage: GrowthStage.Camp, FreeHands: 0, ContentsFit: false, StoredWater: 0, OtherWorkUnderway: true));
		}
		...
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.HeldOnThisGround, AssessReady(HeldOnThisGround: true, HeldByFounder: true));
		}
		...
		{
			ClassicAssert.AreEqual(expected, AssessReady(Stage: stage, StageNeeded: needed));
		}
		...
		{
			ClassicAssert.AreEqual(expected, AssessReady(FreeHands: freeHands, CrewNeeded: crewNeeded));
		}
		...
		public void Assess_WouldSpillIsCheckedBeforeTheWaterIsCounted()
		{
			...
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.WouldSpill, AssessReady(ContentsFit: false));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.WouldSpill, AssessReady(ContentsFit: false, StoredWater: 0));
		}

		[Test]
		public void Assess_TheStoresAreNeverDrawnBelowWhatTheSettlementLivesOn()
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotEnoughWater, AssessReady(StoredWater: 39, Cost: 10, Reserve: 30));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.Ready, AssessReady(StoredWater: 40, Cost: 10, Reserve: 30));
		}
		...
		public void Assess_ThePacingGateIsLastSoAReadyWorkReportsTheHonestReason()
		{
			...
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.WorksElsewhere, AssessReady(OtherWorkUnderway: true));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotEnoughWater, AssessReady(OtherWorkUnderway: true, StoredWater: 0));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotEnoughHands, AssessReady(OtherWorkUnderway: true, FreeHands: 0));
		}
		...
		public void IsReady_IsTrueForExactlyOneVerdict()
		{
			...
			foreach (KingdomUpgradeRules.UpgradeVerdict verdict in Verdicts())
			{
				...
				{
					ready++;
					ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.Ready, verdict);
				}
			}
		...
		public void EveryVerdictIsEitherSilentForAReasonOrCarriesASentence()
		{
			...
			foreach (KingdomUpgradeRules.UpgradeVerdict verdict in Verdicts())
			{
				...
				{
					ClassicAssert.IsNotNull(line, verdict + " is blocked and says nothing");
					ClassicAssert.AreNotEqual("", line.Trim(), verdict + " is blocked and says nothing");
				}
				else
				{
					ClassicAssert.IsNull(line, verdict + " is not a stall and should say nothing");
				}
			}
		}
		...
		{
			ClassicAssert.IsFalse(KingdomUpgradeRules.IsBlocked(verdict));
		}
		...
		public void IsBlocked_IsTrueForEveryOtherVerdict()
		{
			...
			ClassicAssert.AreEqual(Verdicts().Count - 5, blocked);
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.Article(name));
		}
		...
		{
			ClassicAssert.AreEqual(expected, KingdomUpgradeRules.StageWord(stage));
		}
		...
		public void TryParseUpgradeAttributes_AllAbsentIsAnUndefinedChainAndNoError()
		{
			...
			ClassicAssert.IsTrue(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", null, null, null, null, null, out var chain, out var error));
			ClassicAssert.IsNull(error);
			ClassicAssert.IsNotNull(chain);
			ClassicAssert.IsFalse(chain.Defined);
			ClassicAssert.IsNull(chain.SuccessorKey);
		}

		[Test]
		public void TryParseUpgradeAttributes_ReadsAWholeChain()
		{
			ClassicAssert.IsTrue(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "cistern", "9", "1500", "2", "Town", out var chain, out var error));
			ClassicAssert.IsNull(error);
			ClassicAssert.IsTrue(chain.Defined);
			ClassicAssert.AreEqual("cistern", chain.SuccessorKey);
			ClassicAssert.AreEqual(9, chain.CostDramsOverride);
			ClassicAssert.AreEqual(1500L, chain.BuildTicksOverride);
			ClassicAssert.AreEqual(2, chain.CrewOverride);
			ClassicAssert.IsTrue(chain.HasMinStageOverride);
			ClassicAssert.AreEqual(GrowthStage.Town, chain.MinStageOverride);
		}

		[Test]
		public void TryParseUpgradeAttributes_ASuccessorWithNoOverridesLeavesEverySentinelUnset()
		{
			ClassicAssert.IsTrue(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "cistern", null, null, null, null, out var chain, out _));
			ClassicAssert.AreEqual(KingdomUpgradeRules.Unset, chain.CostDramsOverride);
			ClassicAssert.AreEqual(KingdomUpgradeRules.UnsetTicks, chain.BuildTicksOverride);
			ClassicAssert.AreEqual(KingdomUpgradeRules.Unset, chain.CrewOverride);
			ClassicAssert.IsFalse(chain.HasMinStageOverride);
		...
		public void TryParseUpgradeAttributes_RefusesToGuessASuccessor(string cost, string ticks, string crew, string stage)
		{
			...
			ClassicAssert.IsFalse(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", null, cost, ticks, crew, stage, out var chain, out var error));
			ClassicAssert.IsNull(chain);
		...
		{
			ClassicAssert.IsFalse(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "caskrack", null, null, null, null, out var chain, out var error));
			ClassicAssert.IsNull(chain);
		...
		{
			ClassicAssert.IsFalse(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "cistern", null, ticks, null, null, out var chain, out var error));
			ClassicAssert.IsNull(chain);
		...
		{
			ClassicAssert.IsFalse(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "cistern", null, null, crew, null, out var chain, out var error));
			ClassicAssert.IsNull(chain);
		...
		public void TryParseUpgradeAttributes_AcceptsAFreeImprovementAndACrewOfNone()
		{
			...
			ClassicAssert.IsTrue(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "cistern", "0", null, "0", null, out var chain, out _));
			ClassicAssert.AreEqual(0, chain.CostDramsOverride);
			ClassicAssert.AreEqual(0, chain.CrewOverride);
		}
		...
		{
			ClassicAssert.IsFalse(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "cistern", null, null, null, stage, out var chain, out var error));
			ClassicAssert.IsNull(chain);
		...
		{
			ClassicAssert.IsTrue(KingdomUpgradeRules.TryParseUpgradeAttributes("caskrack", "cistern", null, null, null, stage, out var chain, out _));
			ClassicAssert.AreEqual(GrowthStage.Town, chain.MinStageOverride);
		}
		...
		{
			ClassicAssert.AreEqual(-1, KingdomUpgradeRules.ChooseDesignIndex(null));
			ClassicAssert.AreEqual(-1, KingdomUpgradeRules.ChooseDesignIndex(new bool[0]));
		}
		...
		public void ChooseDesignIndex_OneCandidateIsAlwaysTheAnswer(bool chained)
		{
			...
			ClassicAssert.AreEqual(0, KingdomUpgradeRules.ChooseDesignIndex(new bool[1] { chained }));
		}

		[Test]
		public void ChooseDesignIndex_PrefersTheDesignThatCanActuallyAnswerTheQuestion()
		{
			ClassicAssert.AreEqual(2, KingdomUpgradeRules.ChooseDesignIndex(new bool[3] { false, false, true }));
			ClassicAssert.AreEqual(1, KingdomUpgradeRules.ChooseDesignIndex(new bool[3] { false, true, false }));
		}

		[Test]
		public void ChooseDesignIndex_ResolvesTwoChainsByLoadOrder()
		{
			ClassicAssert.AreEqual(0, KingdomUpgradeRules.ChooseDesignIndex(new bool[3] { true, true, false }));
			ClassicAssert.AreEqual(1, KingdomUpgradeRules.ChooseDesignIndex(new bool[3] { false, true, true }));
		}

		[Test]
		public void ChooseDesignIndex_FallsBackToTheFirstWhenNothingCanGrow()
		{
			ClassicAssert.AreEqual(0, KingdomUpgradeRules.ChooseDesignIndex(new bool[3] { false, false, false }));
		}
		...
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.Ready,
		...
		{
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.CraftNotMet,
				AssessDemand(Requirements(CraftMet: false)));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotEnoughHands,
				AssessDemand(Requirements(), FreeHands: 0));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.WouldSpill,
				AssessDemand(Requirements(), ContentsFit: false));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotEnoughWater,
				AssessDemand(Requirements(), StoredWater: 35));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.NotEnoughMaterial,
				AssessDemand(Requirements(MaterialsInHand: false)));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.WorksElsewhere,
				AssessDemand(Requirements(), OtherWorkUnderway: true));
			ClassicAssert.AreEqual(KingdomUpgradeRules.UpgradeVerdict.HeldByFounder,
		...
		public void NoTriggerPathReadsElapsedTimeAsACause()
		{
			...
			foreach (string name in deciders)
			{
				foreach (System.Reflection.MethodInfo method in typeof(KingdomUpgradeRules).GetMethods())
				{
					...
					foreach (System.Reflection.ParameterInfo parameter in method.GetParameters())
					{
						...
						{
							ClassicAssert.IsFalse(Array.IndexOf(clockWords, word) >= 0,
			...
			ClassicAssert.Greater(checkedParameters, 15, "the sweep found almost no parameters to check");
		}
		...
		public void Assess_NeverTakesATickCountAtAll()
		{
			...
			foreach (System.Reflection.MethodInfo method in typeof(KingdomUpgradeRules).GetMethods())
			{
				...
				foreach (System.Reflection.ParameterInfo parameter in method.GetParameters())
				{
					ClassicAssert.IsFalse(parameter.Name.ToLowerInvariant().Contains("tick"),
		...
		public void TheVerdictIsAPureFunctionOfWhatTheSettlementHolds()
		{
			...
			ClassicAssert.AreEqual(first, AssessDemand(demand));
			ClassicAssert.AreEqual(first, AssessDemand(demand));
		}
