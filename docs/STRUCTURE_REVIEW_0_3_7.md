...
Canonical staging enumerated 3100 C# files: 3084 byte-identical to that baseline and 16
changed or added. All remain below 300 physical lines. Complete path/hash/line inventory:
`/tmp/taf-alpha037-structure-inventory.json`. Inventory SHA-256: `438df06e71316df46d649b26b5dbf211cd53c69cf1e61060550dbaba1cb14304`.
...
Relevant validation: source regressions and CI run `34808115103`; the sixteen changed C#
inputs are the same gameplay delta plus candidate version. Native24 tests the runtime at
`1729bae6`, before the candidate version bump, with eighteen synthetic homes. Its result and
