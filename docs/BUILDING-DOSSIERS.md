...
| hut → hutyard (S footprint; S/M/L/XL reservation) | first crewed household | 2–5 | brinestalk/timber, then stone edging | + hearth and terminal yard seat; keeps the tent's empty timber chest | larger reservations use a short return court; a fuller in-place estate would need a new paid successor |
