...
Each successful camp physically contains 48 drams of fresh water in dedicated casks, 12 style-appropriate meals in a larder, and a chest containing 1 mud, 3 brush, and 4 timber. These are finite objects and items. They grant no hidden production and replenish only through ordinary settlement work.
...
- **They drink.** Four settlers at a camp drink 4 drams a day, so the 48 drams you start with last twelve days before construction costs. Four is below the five living residents the water ladder wants, so the camp stage does not change on their account; the first arrival is what moves it.
