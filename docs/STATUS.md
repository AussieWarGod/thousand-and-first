...
| Cold-install inventory | **FROZEN SOURCE SNAPSHOT — 2976 files; release evidence still open** | Canonical staging enumerates 2857 files. Any source or package-inventory change invalidates this snapshot. Package shape does not sign native load, behavior, appearance, or private Steam subscription. |
