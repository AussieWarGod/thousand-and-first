...
|---|---|---|
| Beta full managed suite, 2026-09-05 | **PASS** — 11,138 / 11,138 cases, 0 skipped | Current Quickstart native-harness source contracts, Quickstart/raid-zone/polity-parser delta, and 101 tests of the C# process-ownership policy actually used by Windows tooling. SDK 9.0.306; installed base configured, skips forbidden. The existing ignored creed-kind fixture was copied byte-identically from the release workspace. Both managed projects are engine-free; this is not native play proof. |
| Beta portable suite, 2026-09-05 | **PASS** — 2,702 / 2,702 cases, 0 skipped | Production allocation-scope behavioral tests, shared process-ownership policy, and source wiring checks. The separate native seam run below does not close full embark/save-load acceptance in TESTING QSB1–QSB5 or raid displacement 28b.1–28b.2. |
...
| Staged runtime inventory | **PASS — FOUR COMPILE MODES, 2026-09-05** | The current resolver selects 2949 sources, baseline and compatibility symbols. Production baseline/compatibility compile 2945/2949 sources; development-harness baseline/compatibility compile 2991/2995 sources, including 46 harness shards. Exact installed Hearthpyre 2.2.3 hashes/ABI, generators, and the 2980-file staged copy pass. This is compile/static evidence, not native compatibility behavior. |
| Cold-install inventory | **CURRENT SOURCE SNAPSHOT — 2980 files; package/native release evidence open** | Canonical staging enumerates 2980 files. The tagged Alpha's 2976-file receipt does not cover this beta tree. Package shape does not sign native load, behavior, appearance, or Steam subscription. |
...
| Addendum 9 structural census | **CURRENT SOURCE SNAPSHOT LINE-CAP GREEN; EXACT-INVENTORY REVIEW SIGNED** | 2949 staged C# files / 420,975 physical lines: 0 exceed 300 physical lines, 0 are exactly 300, therefore 0 fail the strict cap; 0 exceed 1,000, 0 exceed 2,000, and 0 exceed 5,000. Direct `XRL` imports: 1376 files, 0 over the line limit. Inventory SHA-256: `9a85ea364957d6a98d8e1649f1a745a03df04f4a09c13441b6a8d94a8443e7c3`. `docs/STRUCTURE_REVIEW.json` is signed against this exact digest by independent AI reviewers under the author's Addendum 9 ruling of 2026-09-02 (see `docs/STRUCTURE.md`). |
