...
| Staged runtime inventory | **STATIC CENSUS CURRENT; FINAL MANAGED RERUN REQUIRED** | The current resolver selects 2944 sources, baseline and compatibility symbols. The retained 10,624-case run predates the final market fan-in, so it is not attributed to these exact sources. Compile success would still not close native compatibility behavior. |
| Cold-install inventory | **FROZEN SOURCE SNAPSHOT — 2974 files; release evidence still open** | Canonical staging enumerates 2857 files. Any source or package-inventory change invalidates this snapshot. Package shape does not sign native load, behavior, appearance, or private Steam subscription. |
...
| Addendum 9 structural census | **FROZEN SOURCE SNAPSHOT LINE-CAP GREEN; EXACT-INVENTORY REVIEW SIGNED** | 2944 staged C# files / 420,651 physical lines: 0 exceed 300 physical lines, 0 are exactly 300, therefore 0 fail the strict cap; 0 exceed 1,000, 0 exceed 2,000, and 0 exceed 5,000. Direct `XRL` imports: 1373 files, 0 over the line limit. Inventory SHA-256: `c2e547d56cdf2c3331f40ae1c80d9f1ddd1b85172e1e182728ac66d32c6caba1`. `docs/STRUCTURE_REVIEW.json` is signed against this exact digest by the AI reviewer under the author's Addendum 9 ruling of 2026-09-02 (see `docs/STRUCTURE.md`). |
...
- Addendum 9 structural release gate is closed for the current digest: every staged C# file is
  ...
  `c2e547d56cdf2c3331f40ae1c80d9f1ddd1b85172e1e182728ac66d32c6caba1`, signed by the AI reviewer
