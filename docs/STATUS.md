...
|---|---|---|
| Beta full managed suite, 2026-09-05 | **PASS** — 11,037 / 11,037 cases, 0 skipped | Current Quickstart native-harness source contracts plus the Quickstart, raid-zone, and polity-parser delta. SDK 9.0.306; installed base configured, skips forbidden. The existing ignored creed-kind fixture was copied byte-identically from the release workspace. Both managed projects are engine-free; this is not native play proof. |
| Beta portable suite, 2026-09-05 | **PASS** — 2,601 / 2,601 cases, 0 skipped | Production allocation-scope behavioral tests and source wiring checks. The separate native seam run below does not close full embark/save-load acceptance in TESTING QSB1–QSB5 or raid displacement 28b.1–28b.2. |
