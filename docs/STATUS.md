...
| Staged runtime inventory | **PASS — FOUR CANONICAL COMPILE MODES, 2026-09-05 03:30:40 UTC** | Resolver selects 2950 sources, baseline and compatibility symbols. Ordinary baseline/compatibility compile 2946/2950 sources; development baseline/compatibility compile 2995/2999, including 49 Harness shards. Current 2981-file stage, installed Hearthpyre 2.2.3 hashes/ABI, generators, and exact compile receipt pass. Retained `/tmp/taf-stage.gieOAK` and `/tmp/taf-devharness.Nun9Va`; compiler-inventory digest `3cfc59f78ac851ba8e0ad4b47e821c7928553427297901e887dffcc1332b6bdd`. Gate uses tracked `latest`; explicit 7.3 proof is separate below. None of this is native compatibility behavior. |
| Strict C# 7.3 direct-source preflight | **PASS — all four modes, 2026-09-05** | Mechanical lambda rename removes the pre-existing CS0136 without behavior changes. Final ordinary baseline/compatibility inventories 2946/2950 and development inventories 2995/2999 (49 Harness shards) compile under explicit 7.3; only expected CS2023 warning. Runtime and compiler-inventory digests stayed unchanged before/after. RSPs, logs, and results retained in `/tmp/taf-direct-qud-preflight.L7g16M`; this separate preflight does not mint a canonical stage receipt or prove native gameplay. |
| Cold-install inventory | **CURRENT SOURCE SNAPSHOT — 2981 files; package/native release evidence open** | Canonical staging enumerates 2981 files. The tagged Alpha's 2976-file receipt does not cover this beta tree. Package shape does not sign native load, behavior, appearance, or Steam subscription. |
...
| Addendum 9 structural census | **CURRENT SOURCE SNAPSHOT LINE-CAP GREEN; EXACT-INVENTORY REVIEW SIGNED** | 2950 staged C# files / 420,999 physical lines: 0 exceed 300 physical lines, 0 are exactly 300, therefore 0 fail the strict cap; 0 exceed 1,000, 0 exceed 2,000, and 0 exceed 5,000. Direct `XRL` imports: 1376 files, 0 over the line limit. Inventory SHA-256: `39afb89cc8d7ea54454a2dc9991f6729496285541d32a4ad868e985a88d72b88`. `docs/STRUCTURE_REVIEW.json` binds the retained baseline plus independently reviewed one-file lambda rename to this exact digest under the author's Addendum 9 ruling of 2026-09-02 (see `docs/STRUCTURE.md`). |
