...
|---|---|---|
| Beta full managed suite, 2026-09-05 | **PASS** — 11,226 / 11,226 cases, 0 skipped | Twelve new subsidence native-harness source contracts plus thirteen production completion-boundary cases; current Quickstart, raid, lifecycle, discovery, and process-ownership coverage retained. The persona source contract now requires raw-log preservation, counted literal expected diagnostics, and strict checking before journal assertion. SDK 9.0.306; installed base configured, skips forbidden. Existing ignored creed-kind evidence remains byte-identical to the release workspace. Both projects are engine-free; this is not native play proof. |
| Beta portable suite, 2026-09-05 | **PASS** — 2,789 / 2,789 cases, 0 skipped | Production allocation-scope and lifecycle/outbox behavioral tests, discovery guard, shared process-ownership policy, and source wiring checks including twelve new subsidence harness contracts. Native seam runs do not close full embark/save-load acceptance in TESTING QSB1–QSB5 or raid displacement 28b.1–28b.2. |
...
| Staged runtime inventory | **PASS — FOUR CANONICAL COMPILE MODES, 2026-09-05 04:50 UTC** | Resolver selects 2951 sources, baseline and compatibility symbols. Unchanged production inventory: ordinary baseline/compatibility 2947/2951 sources, 2982 staged files, runtime digest `261e2b57d250359ac7ad1ea77a365aa1275360ac41b418523f5c5a138edf68d9`. Development baseline/compatibility now compile 3000/3004 sources, including 53 Harness shards. Installed Hearthpyre 2.2.3 hashes/ABI, generators, and canonical receipt pass. Retained `/tmp/taf-stage.PSIAiK` and `/tmp/taf-devharness.8wHdfh`; compiler digest `1aba3827bdd3377945c6f72f7243f23f0b3f968fd0c59518b9cd7ee021c2a887`. No native compatibility or subsidence claim follows from compilation. |
| Strict C# 7.3 direct-source preflight | **PASS — all four modes, 2026-09-05** | Ordinary baseline/compatibility 2947/2951 and development 3000/3004 (53 Harness shards) compile under explicit 7.3; only expected CS2023. Exact runtime/compiler digests and ABI/template hashes agree before/after. Retained `/tmp/taf-direct-qud-preflight.SSwfxo`, before/after receipt SHA-256 `9e60b9f41c6a7bd7d63ec0ed93dd9bf5999c9414a1ef55e3cb09e57a7fdf8ad6` / `b17bb716f8234225eccf203c665ed795d92a26e01e4d0a3a105e7ab971459a41`. Separate direct-source proof, not a canonical stage or native gameplay receipt. |
...
| Tools tests | **PASS — 333 / 333 tests** | Eight new literal-diagnostic parser/filter tests and four actual-shell expected-diagnostic lifecycle tests extend the previous suite. Raw archives remain intact; missing, repeated, and unrelated diagnostics or a refused journal cannot become a PASS. Exact mode also rejects unlisted gate-refusal frames; original source-order tests pin the separate derived check input before journal assertion. |
