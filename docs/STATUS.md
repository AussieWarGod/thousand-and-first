...
|---|---|---|
| Beta full managed suite, 2026-09-05 | **PASS** — 11,214 / 11,214 cases, 0 skipped | Thirteen new subsidence completion-boundary cases plus current Quickstart and 14 raid-outbox native-harness source contracts, Quickstart/raid-zone/polity-parser delta, 34 actual lifecycle/outbox behavioral cases, 14 discovery-guard cases, and 101 tests of the C# process-ownership policy actually used by Windows tooling. SDK 9.0.306; installed base configured, skips forbidden. The existing ignored creed-kind fixture was copied byte-identically from the release workspace. Both managed projects are engine-free; this is not native play proof. |
| Beta portable suite, 2026-09-05 | **PASS** — 2,777 / 2,777 cases, 0 skipped | Production allocation-scope and lifecycle/outbox behavioral tests, discovery guard, shared process-ownership policy, and source wiring checks. The separate native seam run below does not close full embark/save-load acceptance in TESTING QSB1–QSB5 or raid displacement 28b.1–28b.2. |
| Subsidence post-loop summary ordering, 2026-09-05 | **PASS — 13 / 13 focused cases in each managed project; native unsigned** | Actual production completion boundary and its Reckoning wiring: bookkeeping and reached-rung invocation precede summary formatting/ledger/Chronicle delivery; summary and diagnostic failures are contained, required-work failures are not. The extracted old ordering failed 12 of 13 new checks. Full-step native replay remains untested. Fractional-step debt, committed-but-pending resident departures, and interruptions inside rung execution remain known open defects; no exactly-once claim. See [TESTING.md](../TESTING.md#beta-subsidence-completion--bounded-evidence-and-open-recovery). |
...
| Staged runtime inventory | **PASS — FOUR CANONICAL COMPILE MODES, 2026-09-05 04:09:47 UTC** | Resolver selects 2951 sources, baseline and compatibility symbols. Ordinary baseline/compatibility compile 2947/2951 sources; development baseline/compatibility compile 2996/3000, including 49 Harness shards. Current 2982-file stage, installed Hearthpyre 2.2.3 hashes/ABI, generators, and exact compile receipt pass. Retained `/tmp/taf-stage.deFAPN` and `/tmp/taf-devharness.j7j7B5`; compiler-inventory digest `04c89e0ca83d97a284357ffe71bea14a22d5621e05c7688b725337c523c1af81`. Gate uses tracked `latest`; explicit 7.3 proof is separate below. None of this is native compatibility behavior or subsidence gameplay. |
| Strict C# 7.3 direct-source preflight | **PASS — all four modes, 2026-09-05** | Current ordinary baseline/compatibility inventories 2947/2951 and development inventories 2996/3000 (49 Harness shards) compile under explicit 7.3; only expected CS2023 warning. Runtime and compiler-inventory digests stayed unchanged before/after; tracked ABI fixture compiles under canonical latest. RSPs, logs, and results retained in `/tmp/taf-direct-qud-preflight.EAGxZl`, results SHA-256 `26118289fbb49ec53ab98b111d3bfbb6742e8a5a77c6c92ab411ca60523f1491`. This separate preflight does not mint a canonical stage receipt or prove native gameplay. |
...
| Addendum 9 structural census | **CURRENT SOURCE SNAPSHOT LINE-CAP GREEN; EXACT-INVENTORY REVIEW SIGNED** | 2951 staged C# files / 421,022 physical lines: 0 exceed 300 physical lines, 0 are exactly 300, therefore 0 fail the strict cap; 0 exceed 1,000, 0 exceed 2,000, and 0 exceed 5,000. Direct `XRL` imports: 1376 files, 0 over the line limit. Inventory SHA-256: `261e2b57d250359ac7ad1ea77a365aa1275360ac41b418523f5c5a138edf68d9`. `docs/STRUCTURE_REVIEW.json` binds the retained baseline plus independently reviewed two-file subsidence completion delta to this exact digest under the author's Addendum 9 ruling of 2026-09-02 (see `docs/STRUCTURE.md`). |
...
| Tools tests | **PASS** — 321 / 321 tests | Repository tooling, five executable removal-inventory generator tests, eight actual-shell lifecycle tests with mocked Windows boundaries, eight process-ownership source contracts, generators, gallery census, documentation contracts, and package helpers are green at this checkpoint. |
...
- Addendum 9 structural release gate is closed for the current digest: every staged C# file is
  ...
  `9a85ea364957d6a98d8e1649f1a745a03df04f4a09c13441b6a8d94a8443e7c3`, signed by independent AI reviewers
