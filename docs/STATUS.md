...
|---|---|---|
| Beta full managed suite, 2026-09-05 | **PASS** — 11,026 / 11,026 cases, 0 skipped | Current Quickstart, raid-zone, and polity-parser delta. SDK 9.0.306; installed base configured, skips forbidden. The existing ignored creed-kind fixture was copied byte-identically from the release workspace. Both managed projects are engine-free; this is not native play proof. |
| Beta portable suite, 2026-09-05 | **PASS** — 2,601 / 2,601 cases, 0 skipped | Same source delta, including production allocation-scope behavioral tests and source wiring checks. Native callbacks, save/load, and displacement remain unsigned in TESTING QSB1–QSB5 and 28b.1–28b.2. |
...
| Staged runtime inventory | **PASS — FOUR COMPILE MODES, 2026-09-05** | The current resolver selects 2949 sources, baseline and compatibility symbols. Production baseline/compatibility compile 2945/2949 sources; development-harness baseline/compatibility compile 2987/2991 sources. Exact installed Hearthpyre 2.2.3 hashes/ABI, generators, and the 2980-file staged copy pass. This is compile/static evidence, not native compatibility behavior. |
