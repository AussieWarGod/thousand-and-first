...
Five new source/rule regressions pass; native multi-raider callback/custody acceptance remains open.
Earlier native receipts below do not exercise this new launch path. The next Alpha also requires
...
| Staged runtime inventory | **PASS — FOUR CANONICAL COMPILE MODES, 2026-09-05 05:38 UTC** | Ordinary baseline/compatibility 2947/2951 sources, 2982 staged files, runtime digest `f9815fff2a1cf4389ecd42b733645b0611b31bbc8b58c96fae7d1636099e81b1`. Development baseline/compatibility 3000/3004 sources, including 53 Harness shards. Installed Hearthpyre 2.2.3 hashes/ABI, generators, and canonical receipt pass. Retained `/tmp/taf-stage.yMfvUH` and `/tmp/taf-devharness.wxK8Zl`; compiler digest `41593bb66706cb66217e9d77fb8ff0813b308d1b97d5fd5a1e174e4f63a1de5e`. This verifies the Claude launch-order source, not native launch behavior, compatibility, or save/load. |
| Strict C# 7.3 direct-source preflight | **PASS — all four modes, 2026-09-05** | Ordinary baseline/compatibility 2947/2951 and development 3000/3004 (53 Harness shards) compile under explicit 7.3; only expected CS2023. Exact runtime/compiler digests and ABI/template hashes agree before/after. Retained `/tmp/taf-raid-order-preflight.bGVnh7`, before/after receipt SHA-256 `19999f87577086ce93f7d60d22eea24f333c86a8578dda0931fbc7f034eded0d` / `c0b57f62b585bf2966c9de2c6e763dc3352f7c5c73cacc2d8ff61e4b4a204057`. Separate direct-source proof, not a canonical stage or native gameplay receipt. |
