...
The map above covers 131 additional semantic decompositions in the current hardening sequence; with
the prior ten, 141 oversized authorities have been decomposed. This is 12 more than checkpoint
`2cb97fc`, six more than checkpoint `d3fc4b9`, and three more than checkpoint `b049c17`. Each family
remains one logical authority only where Qud ABI or transaction
