...
The map above covers 128 additional semantic decompositions in the current hardening sequence; with
the prior ten, 138 oversized authorities have been decomposed. This is nine more than checkpoint
`2cb97fc` and three more than checkpoint `d3fc4b9`. Each family remains one logical authority only where Qud ABI or transaction
