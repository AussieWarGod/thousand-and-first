...
`Tools/check-structure.py --json` currently reports 2944 staged production C# files and 420,651
...
`c2e547d56cdf2c3331f40ae1c80d9f1ddd1b85172e1e182728ac66d32c6caba1`. The census reports
