...
namespace ThousandAndFirst
{
	internal static partial class KingdomInheritRules
	{
		...
		private static readonly Definition[] Definitions = new Definition[]
		{
			...
			D("terrace", "r_KingdomTerrace", 12, 10),
			D("finehouse", "r_KingdomFineHouse", 8, 6),
			D("manor", "r_KingdomManor", 12, 10),
			D("court", "r_KingdomCourt", 20, 18),
			D("saltpan", "r_KingdomSaltPan", 6, 4),
			D("saltterrace", "r_KingdomSaltTerrace", 6, 4),
			D("catchment", "r_KingdomCatchment", 6, 4),
			D("catchmentbank", "r_KingdomCatchmentBank", 6, 4),
			D("airwellcourt", "r_KingdomAirWellCourt", 8, 6),
			D("airwellfield", "r_KingdomAirWellField", 12, 10),
			D("weeptap", "r_KingdomWeepTap", 6, 4),
			D("weepgallery", "r_KingdomWeepGallery", 8, 6),
			D("cistern", "r_KingdomGreatCistern", 8, 6),
			D("cisternvault", "r_KingdomCisternVault", 8, 6),
			D("reservoir", "r_KingdomReservoir", 12, 10),
			D("waterworks", "r_KingdomWaterworks", 20, 18),
			D("condensery", "r_KingdomCondensery", 20, 18),
			D("larder", "r_KingdomLarder", 6, 4),
			D("plot", "r_KingdomPlot", 6, 4),
			D("plotrows", "r_KingdomPlotRows", 6, 4),
			D("field", "r_KingdomField", 8, 6),
			D("fieldrows", "r_KingdomFieldRows", 8, 6),
			D("granary", "r_KingdomGranary", 8, 6),
			D("grange", "r_KingdomGrange", 12, 10),
			D("homefarm", "r_KingdomHomeFarm", 20, 18),
			D("toolshed", "r_KingdomToolShed", 6, 4),
			D("chargingpost", "r_KingdomChargingPost", 6, 4),
			...
			D("oven", "r_KingdomOven", 6, 4),
			D("bench", "r_KingdomBench", 6, 4),
			D("hall", "r_KingdomHall", 8, 6),
			D("bazaar", "r_KingdomBazaar", 8, 6),
			D("bathhouse", "r_KingdomBathhouse", 12, 10),
			D("heartbasin", "r_KingdomRiteGround", 4, 4),
			D("heartwaterstone", "r_KingdomWaterstone", 8, 6),
			D("heartmoot", "r_KingdomMootYard", 12, 10),
			D("heartcourt", "r_KingdomGreatCourt", 20, 18),
			D("shrine", "r_KingdomShrine", 6, 4),
			D("shrinegarth", "r_KingdomShrineGarth", 6, 4),
			D("temple", "r_KingdomTemple", 12, 10),
			...
			D("barracks", "r_KingdomBarracks", 12, 10),
			D("cairn", "r_KingdomCairn", 6, 4),
			D("mill", "r_KingdomMill", 6, 4),
			D("waterwheel", "r_KingdomWaterWheel", 6, 4),
			D("sailvane", "r_KingdomSailvane", 6, 4),
			...
			D("vaultgalleries", "r_KingdomVaultGalleries", 12, 10),
			D("deepcut", "r_KingdomDeepCut", 8, 6),
			D("nichetomb", "r_KingdomNicheTomb", 6, 4),
			D("delve", "r_KingdomDelve", 8, 6),
			D("underbench", "r_KingdomUnderBench", 8, 6),
			D("reliquary", "r_KingdomReliquary", 12, 10),
			D("factorhouse", "r_KingdomFactorHouse", 8, 6),
			D("butcherslab", "r_KingdomButcherSlab", 6, 4),
			D("vathouse", "r_KingdomVatHouse", 8, 6),
			D("graftinghall", "r_KingdomGraftingHall", 12, 10),
			D("chimerictheatre", "r_KingdomChimericTheatre", 20, 18),
			D("becomingannexe", "r_KingdomBecomingAnnexe", 20, 18),
			D("mirrorgate", "r_KingdomMirrorGate", 11, 8),
			D("crownhall", "r_KingdomCrownHall", 14, 10),
			D("arcology", "r_KingdomArcology", 20, 18),
			D("arcologyward", "r_KingdomArcologyWard", 12, 10),
