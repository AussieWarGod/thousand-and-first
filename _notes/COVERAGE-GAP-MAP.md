...
| Upgrades climb within a plot; sizes compete across; no in-place S→M | Plots | BUILT | `UpgradesTo` chains; validator refuses improvement onto a larger plot, `Growth/KingdomCatalogueRules*.cs` | — |
